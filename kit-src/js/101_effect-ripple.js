 ...
 */
var SSTRipple = function SSTRipple(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};

window['SSTRipple'] = SSTRipple;

SSTRipple.prototype.Constant_ = {
...
SSTRipple.prototype.CssClasses_ = {
    RIPPLE_CENTER: 'sst-ripple--center',
    RIPPLE_EFFECT_IGNORE_EVENTS: 'sst-js-ripple-effect--ignore-events',
    RIPPLE: 'sst-ripple',
    IS_ANIMATING: 'sst-is-animating',
    IS_VISIBLE: 'sst-is-visible'
};

SSTRipple.prototype.downHandler_ = function (event) {
...
SSTRipple.prototype.upHandler_ = function (event) {
...
SSTRipple.prototype.init = function () {
    if (this.element_) {
